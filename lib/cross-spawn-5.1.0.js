...
var resolveCommand_1 = resolveCommand$2; // See: https://github.com/IndigoUnited/node-cross-spawn/pull/34#issuecomment-221623455
...
function escapeCommand$1(command) {
  ...
  return /^[a-z0-9_-]+$/i.test(command) ? command : escapeArgument$1(command, true);
}
